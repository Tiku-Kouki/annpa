...
void Player::Move(char* keys, char* preKeys)
{
	...
	case STAGE:
		...
		//左向きの当たり判定
		if (charaDir == LEFT) {
			int tmpPosX = bullet->playerBulletPosX - bullet->bulletRadius;
			int tmpPosY = bullet->playerBulletPosY - bullet->bulletRadius;
			int tmpPosY1 = bullet->playerBulletPosY + bullet->bulletRadius;
